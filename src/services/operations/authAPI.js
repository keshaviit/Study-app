...
// now we destructring the api call
const {
  SENDOTP_API,
  SIGNUP_API,
  LOGIN_API,
...
export function resetPasswordToken(email ,setSendEmail){
  ...
  return async (dispatch) =>{
    ...
    try{
      ...
      toast.error("Failed to send the Reset password Email")
    }
    dispatch(setLoading(false));
...
export function resetPassword(password,confirmPassword,token){
  return async(dispatch) =>{
    ...
    try{
      ...
      console.log("The Password is Successfully Updated ",response);
      ...
      console.log("facing problem in updating the password",error)
